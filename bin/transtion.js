...
var index_1 = require("../node_modules/ffmpeg-transitions/dist/index");
var videoPaths = [
...
var output = "/media/Videos/Plex/XXX/Studios/Home Videos/Compilation/test.mp4";
// For a single transition type for all videos
var transition = 'slideleft'; // Transition type
...
// ];
var transitionDuration = 2; // Transition duration in seconds, used if a single transition type is provided
(0, index_1.blendVideos)(videoPaths, output, transition, transitionDuration, function (err, result) {
    if (err) {
