...
trait Lang
{
    ...
    public const L__APP_DEFAULT_PATH      = 'Path of some sort';
    ...
    public const L__DEFAULT_SHOW_NEWFILES = 'Search new added files';
    ...
    public const L__DISPLAY_SHOW          = 'Show added Value';
    public const L__DISPLAY_HIDE          = 'Hide added Value';
