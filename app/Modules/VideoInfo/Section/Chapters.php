...
class Chapters extends VideoInfo
{
    use MediaFFmpeg;
    ...
    public function get($key, $file)
    {
        ...
        // utmdd($this->video_file,$this->video_key,$this->video_chapters);
        //        $VideoData             = new VideoData();
        //        $VideoData->video_file = $this->video_file;
        $thumbnail        = $this->getChapterImg();
    ...
    public function getChapterImg()
    {
        ...
        foreach ($this->video_chapters as $timeCode) {
            foreach ($timeCode as $id => $time) {
                ...
                $thumbnailImages[] = ['id' => $id, 'chapterThumbnail' => $img_file];
            }
        }
    ...
    public function getVideoInfo($key, $row)
    {
        ...
        $this->video_chapters[] = $row['timeCode'];
        $this->video_key        = $key;
