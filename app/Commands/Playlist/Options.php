...
class Options extends MediaOptions
{
    ...
    public function Definitions()
    {
        ...
        return [
            ...
            ['premium', 'P', InputOption::VALUE_NONE, self::text('L__PLAYLIST_PREMIUM')],
            ...
            ['skip', 's', InputOption::VALUE_NONE, self::text('L__PLAYLIST_SKIP')],
            //  ['compact', 'c', InputOption::VALUE_NONE, self::text('L__PLAYLIST_COMPACT')],
            ['clean', null, InputOption::VALUE_NONE, self::text('L__PLAYLIST_CLEAN')],
            ['ignore', 'i', InputOption::VALUE_NONE, self::text('L__PLAYLIST_IGNORE')],
            ['debug', null, InputOption::VALUE_NONE, self::text('L__PLAYLIST_DEBUG')],
