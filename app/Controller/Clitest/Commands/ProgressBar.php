...
namespace Mediatag\Controller\Clitest\Commands;
...
#[AsCommand(name: 'progressbar', description: 'Examples of progress bar')]
class ProgressBar extends MediaCliCommand
{
    ...
    protected function executeAction(): int
    {
        ...
        if ($caseName === self::CASE_MILLION_SYMFONY) {
            ...
            $progressBar = new SymfonyProgressBar($this->outputMode->getOutput(), 1_000_000);
