...
$box = new \Mediatag\Bundle\Dialog\Widgets\Inputmenu('Change items:', 0,
...
//    new \Mediatag\Bundle\Dialog\Options\MenuItem('textual item', 'Another item')//dont use spaces into tag
    new \Mediatag\Bundle\Dialog\Options\MenuItem('textual', 'Another item')
);
